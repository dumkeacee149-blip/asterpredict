...
import { Bebas_Neue, Chakra_Petch, Space_Grotesk, Space_Mono } from "next/font/google";
import "./globals.css";
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <html lang="en" className={`${bebasNeue.variable} ${chakraPetch.variable} ${spaceGrotesk.variable} ${spaceMono.variable} h-full antialiased`}>
